                ...
                {categoryOptions?.map(category => {
                  return (
                      <Link
                          ...
                          <div
                              className={
                                  ' duration-300 dark:hover:text-white dark:text-gray-200 rounded-md px-3 cursor-pointer py-1 hover:bg-indigo-600 dark:hover:bg-yellow-600 hover:text-white'
                              }
                          >
