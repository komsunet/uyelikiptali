...
export const MenuItemCollapse = ({ link }) => {
  ...
  return <>
        <div className='select-none w-full px-2 py-2 border rounded-md text-left dark:bg-hexo-black-gray' onClick={toggleShow} >
            {!hasSubMenu && <Link
        ...
        {/* 折叠子菜单 */}
        {hasSubMenu && <Collapse isOpen={isOpen} className='rounded-md'>
