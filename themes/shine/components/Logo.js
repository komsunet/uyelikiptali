...
const Logo = props => {
  ...
  return (
        <Link href='/' passHref legacyBehavior>
            <div className='flex flex-nowrap justify-center items-center cursor-pointer font-bold'>
                <LazyImage src={siteInfo?.icon} width={24} height={24} alt={BLOG.AUTHOR} className='mr-2 hidden md:block' />
                <div id='logo-text' className='group rounded-md flex-none relative'>
                    ...
                    <div className='flex justify-center rounded-md group-hover:bg-gray-600 w-full group-hover:opacity-100 opacity-0 invisible group-hover:visible absolute top-0 py-1 duration-200'>
