  ...
  return (<>
        ...
        <div className='lg:hidden w-full flex flex-row'>
            ...
            <Link
                ...
                rel="prev"
                className={`${showPrev ? 'block' : 'hidden'} dark:text-white relative w-full flex-1 h-14 flex items-center transition-all duration-200 justify-center py-2 px-2 bg-white dark:bg-[#1e1e1e] border rounded-md cursor-pointer`}>
                {locale.PAGINATION.PREV}
            </Link>
            ...
            <Link
                ...
                rel="next"
                className={`${+showNext ? 'block' : 'hidden'} dark:text-white relative w-full flex-1 h-14 flex items-center transition-all duration-200 justify-center py-2 px-2 bg-white dark:bg-[#1e1e1e] border rounded-md cursor-pointer`}>
                {locale.PAGINATION.NEXT}
            </Link>
        </div>
    </>)
