const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-09-25', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  NOTICE_BAR: [
    // { title: 'Burdayız!', url: 'https://blog.https://sarmelseyh.com' },
    // { title: 'Nerdeyiz?', url: 'https://docs.https://sarmelseyh.com' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: 'Hello',
  HERO_TITLE_2: 'Hello 2',
  HERO_TITLE_3: 'TANGLY1024.COM',
  HERO_TITLE_4: 'Hello 4',
  HERO_TITLE_5: 'Şarmda durum nasıl?',
  HERO_TITLE_LINK: 'https://sarmelseyh.com',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: 'cat 1', url: '/tag/必看精选' },
  HERO_CATEGORY_2: { title: 'cat 2', url: '/tag/热门文章' },
  HERO_CATEGORY_3: { title: 'cat 3', url: '/tag/实用教程' },

  // 英雄区右侧推荐文章标签, 例如 [推荐] , 最多六篇文章; 若留空白''，则推荐最近更新文章
  HERO_RECOMMEND_POST_TAG: 'Bu da ne?',
