...
const LayoutBase = props => {
  ...
  return (
    <div
      id="theme-heo"
      className="bg-[#ffffff] dark:bg-[#18171d] h-full min-h-screen flex flex-col"
    >
      {/* SEO信息 */}
      ...
      <main
        id="wrapper-outer"
        className={'flex-grow w-full max-w-[86rem] mx-auto relative md:px-0'}
      >
        <div
          id="container-inner"
          className={
...
const LayoutIndex = props => {
  const headerSlot = (
    <header>
      ...
      {/* 通知横幅 */}
      <NoticeBar />
      <div className="max-w-[86rem] mx-auto px-3 md:px-0">
      <Hero {...props} />
      </div>
    </header>
  )
  ...
  return (
    <LayoutBase {...props} headerSlot={headerSlot}>
      <div id="post-outer-wrapper" className="px-3 md:px-0">
        {/* 文章分类条 */}
...
const LayoutSlug = props => {
  ...
  return (
    <LayoutBase
      ...
      slotRight={slotRight}
    >
      <div className={`w-full xl:max-w-5xl ${hasCode ? 'xl:w-[73.15vw]' : ''} lg:hover:shadow lg:border rounded-md lg:px-2 lg:py-4 bg-white dark:bg-[#18171d] dark:border-gray-600 article`}>
          ...
          >
            ...
            <div className="error-content flex flex-col md:flex-row w-full mt-12 h-[30rem] md:h-96 justify-center items-center bg-white border rounded-3xl">
              ...
              <div className="error-info flex-1 flex flex-col justify-center items-center space-y-4">
                ...
                <div>Bu sayfayı bulamadık. Ama bu da önemli değil. Çünkü burada keşfedilecek daha çok şey var.</div>
                <Link href="/">
